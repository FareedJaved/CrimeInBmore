...
File.foreach("BPD_Arrests.csv") { |line|  
	...
	s = line.split(",") 
	year = s[4].split("/")
	if s[7] == "Unknown Offense" && year[2] == "2013"  
		unknown = unknown + 1
...
puts "Just from looking at Arrest data from the Baltimore Police Dept. in 2013..."
puts
...
printf("%2d", a )
print " percent of total arrests that the BPD made in 2013"
puts
puts
...
# puts 
# print "This means that around 1 out of 5 people who are arrested in Baltimore are done so for an unknown reason. Additionally, 
# 	every time that 1 person is arrested, theres a 4/5 chance that the person is African American"

# puts 
# puts "Lets look at the charges were for those who were arrested for an unknown offense..."
# puts "Of the African Americans who were arrested, #{b_loit} were charged with Loitering or an Unknown Offense"
# printf("That means that %2d percent of African Americans who were arrested for an Unknown Offense were charged with Loitering or 
# 	for no reason at all", (b_loit.to_f/b.to_f)*100)
...
# 	were #{w_loit}"
# puts "That means that African Americans were 5 times as likely to be arrested for standing around than a white person"
